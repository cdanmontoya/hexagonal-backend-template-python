...
from src.infrastructure.adapters.input.events.python_template.account_not_deleted import AccountNotDeletedProcessor
...
class RabbitMqEventConsumer(EventConsumer):
    ...
    async def on_message(self, message: AbstractIncomingMessage) -> None:
        async with message.process():
            integration_event = IntegrationEvent.model_validate_json(message.body.decode("utf-8"))
